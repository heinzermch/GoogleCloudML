# Hello world example which involves storing output.
# No input external involved. However it stores the model state in an external bucket
# code from https://github.com/hunkim/GoogleCloudMLExamples/tree/master/train
